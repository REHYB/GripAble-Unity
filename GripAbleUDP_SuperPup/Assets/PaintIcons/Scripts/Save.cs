...
public class Save : MonoBehaviour {
    ...
    public void SaveRawData() {
        writer = new StreamWriter(destination, true);
        writer.WriteLine(DateTime.Now.Hour*3600+DateTime.Now.Minute*60+DateTime.Now.Second + "." + DateTime.Now.Millisecond + "," + PaintGame.force + "," + PaintGame.climberForceScale + "," + PaintGame.climberPosition + "," + PaintGame.appleHeight + "," + PaintGame.bonesCaught + "," + PaintGame.reps + "," + PaintGame.angleYaw + "," + PaintGame.anglePitch + "," + PaintGame.angleRoll);
        writer.Close();
    }
}